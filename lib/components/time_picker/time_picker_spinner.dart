...
class _TimePickerSpinnerState extends State<TimePickerSpinner> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> contents = [
      ...
      spacer(),
      SizedBox(width: 20, height: 42, child: Center(child: Text(':', style: _getHighlightedTextStyle()))),
      spacer(),
      SizedBox(
        width: _getItemWidth(),
        height: _getItemHeight()! * 3,
    ...
    Widget spinner = NotificationListener<ScrollNotification>(
      ...
      child: ListView.builder(
        itemBuilder: (context, index) {
          ...
          if (widget.isForce2Digits && text != '' && controller != hourController) {
  ...
  Widget apSpinner() {
    final apList = widget.useMultiLanguage
        ? [
            '',
            context.localeString.t_ui_public_am,
            context.localeString.t_ui_public_pm,
            '',
          ]
        : [
            '',
